...
def write_file(dict, file_name):
    with open(f"D:\OneDrive\OneDrive - HTL Anichstrasse\HTL 5\Python\SWP_Python\Rock_Paper_Scissors_Spock_Lizard\Models\{file_name}.json", "w") as file:
        file.write(json.dumps(dict))

def read_file(file_name):
    with open(f"D:\OneDrive\OneDrive - HTL Anichstrasse\HTL 5\Python\SWP_Python\Rock_Paper_Scissors_Spock_Lizard\Models\{file_name}.json", "r") as file:
...
def post_dict(dict):
    res = requests.post(config.post_url, data=dict)
    print(res.text)
